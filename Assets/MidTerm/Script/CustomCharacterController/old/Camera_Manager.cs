...
public class Camera_Manager : MonoBehaviour {
	...
	public	LayerMask	CameraObstructionLayerMask;
	...
	public static void InitialCameraCheck() {
		...
		if (Camera.main == null) {
			...
			if (Camera.main.gameObject.GetComponent<Camera_Manager>() == null) {
	...
	private void CollisionPointCheck(Vector3 start, Vector3 end, ref float newDistance) {
		...
		if (Physics.Linecast(start, end, out hitInfo, this.CameraObstructionLayerMask)) {
